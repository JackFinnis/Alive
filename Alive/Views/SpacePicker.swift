    ...
    var body: some View {
        VStack {
            Menu {
                ...
                Section("Alive") {
                    ShareLink(item: URL(string: "https://apps.apple.com/app/id6754123631")!) {
                        Label("Share Alive", systemImage: "square.and.arrow.up")
                    }
                    Link(destination: URL(string: "https://jackfinnis.com/apps/quotes")!) {
